...
class Settings extends Component {
        ...
        return (
          <div>
            ...
            <Popconfirm
              placement="topLeft"
              title={`确认删除?`}
              onConfirm={() => this.handleDelete(limit.timeLimitType)}
              okText="确认"
              cancelText="取消"
            >
  ...
  render() {
    const title = (
      <Button type="primary" onClick={() => this.showAddUpdateModal()}>
        添加时间限制
      </Button>
    );
    ...
    return (
      <PageHeaderWrapper>
        <Card title={title}>
          ...
          <Table columns={this.columns} dataSource={timeLimits} rowKey="id" />
        </Card>
      </PageHeaderWrapper>
    );
  }
