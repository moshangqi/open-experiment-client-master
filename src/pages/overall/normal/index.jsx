...
@connect(({  loading,overfunctionall }) => ({

  loading: loading.models.overfunctionall,
  projects:overfunctionall.projects,
}))
class OverAllProjectCheck extends Component {
  state = {
    expandForm: false,
    formValues: {},
    selectedRows: [],
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'overfunctionall/getConclusionProject',
    });
  }
  ...
  handleSearch = (value) =>{
    ...
    console.log(data);
    dispatch({
      type:'overfunctionall/selectConclusionByKeyword',
      payload:{
        data,
      }
    })
...
export default Form.create()(OverAllProjectCheck);
