...
@connect(({ listTableList, loading, overfunctionpass }) => ({
  listTableList,
  loading: loading.models.overfunctionpass,
  projects: overfunctionpass.projects,
}))
class WaitOverMarkCollege extends Component {
  state = {
    expandForm: false,
    formValues: {},
    selectedRows: [],
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'overfunctionpass/getTheSchoolHasCompletedProject',
      payload: {
        data: {},
      },
    });
...
export default Form.create()(WaitOverMarkCollege);
