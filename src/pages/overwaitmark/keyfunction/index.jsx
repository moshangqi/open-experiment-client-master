...
@connect(({ listTableList, loading, overkeyfunctionpass }) => ({
  listTableList,
  loading: loading.models.overkeyfunctionpass,
  projects: overkeyfunctionpass.projects,
}))
class WaitOverMarkkeyFunction extends Component {
  state = {
    expandForm: false,
    formValues: {},
    selectedRows: [],
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'overkeyfunctionpass/getTheSchoolHasCompletedKeyProject',
      payload: {
        data: {},
      },
    });
...
export default Form.create()(WaitOverMarkkeyFunction);
