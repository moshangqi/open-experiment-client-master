...
@connect(({ listTableList, loading,hitproject }) => ({
  listTableList,
  loading: loading.models.hitproject,
  projects:hitproject.projects,
}))



class MidHitProject extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'hitproject/getMidTermReturnProject',
      payload:{
        data:{}
      }
    });
  ...
  handleModalOk = ()=>{
    ...
    if(approvalType === 0){
      dispatch({
        type:'hitproject/rejectIntermediateInspectionProject',
        payload:{
          data,
        }
      })
      ...
      dispatch({
        type:'hitproject/midTermReviewPassed',
        payload:{
          data,
        }
      })
...
export default Form.create()(MidHitProject);
