...
@connect(({ listTableList, loading,overfunctionreturn }) => ({
  listTableList,
  loading: loading.models.overfunctionreturn,
  projects:overfunctionreturn.projects,
}))



class FunctionReturnProject extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'overfunctionreturn/getFunctionReturnProject',
      payload:{
        data:{}
      }
    });
  ...
  handleModalOk = ()=>{
    ...
    if(approvalType === 0){
      dispatch({
        type:'overfunctionreturn/rejectToBeConcludingProject',
        payload:{
          data,
        }
      })
      ...
      dispatch({
        type:'overfunctionreturn/functionReviewPassed',
        payload:{
          data,
        }
      })
...
export default Form.create()(FunctionReturnProject);
