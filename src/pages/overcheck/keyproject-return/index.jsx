...
@connect(({ listTableList, loading,overcollegekeyreturn }) => ({
  listTableList,
  loading: loading.models.overcollegekeyreturn,
  projects:overcollegekeyreturn.projects,
}))



class CollegeReturnKeyProject extends Component {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'overcollegekeyreturn/getCollegeReturnKeyProject',
      payload:{
        data:{}
      }
    });
  ...
  handleModalOk = ()=>{
    ...
    if(approvalType === 0){
      dispatch({
        type:'overcollegekeyreturn/rejectCollegeKeyProject',
        payload:{
          data,
        }
      })
      ...
      dispatch({
        type:'overcollegekeyreturn/collegeReviewPassed',
        payload:{
          data,
        }
      })
...
export default Form.create()(CollegeReturnKeyProject);
