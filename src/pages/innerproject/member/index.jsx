...
@connect(({ loading, applyXStudents, innerProject }) => ({
  loading: loading.models.applyXStudents,
  students: applyXStudents.data,
  projects: innerProject.projects,
  searchStudents: applyXStudents.searchStudents,
}))
class MemberList extends Component {
  ...
  handleSearch = value => {
    ...
    if (value) {
      ...
      dispatch({
        type: 'applyXStudents/saveStudents',
        payload: [],
      });
    }
  };
  ...
  fetchStudents = value => {
    ...
    this.timeout = setTimeout(() => {
      dispatch({
        type: 'applyXStudents/fetchStudents',
        payload: {
          keyWord: value,
          isTeacher: false,
        },
